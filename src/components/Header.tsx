  ...
  return (
    ...
    >
      ...
      <Flex
        ...
        borderRadius="full"
      >
        <Input color="gray.500" variant="unstyled" placeholder="Buscar na plataforma" _placeholder={{ color: "gray.400" }} />
      ...
      <Flex
        ...
        ml="auto"
      >
        <HStack spacing="8" mx="8" pr="8" py="1" color="gray.300" borderRadiusWidth={1} borderColor="gray.700">
